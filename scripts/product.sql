...
ALTER TABLE `catalog_product_link`
    ...
    DROP INDEX IF EXISTS `CATALOG_PRODUCT_LINK_LINK_TYPE_ID_PRODUCT_ID_LINKED_PRODUCT_ID`,
    DROP COLUMN IF EXISTS `product_id`,
    CHANGE COLUMN `new_product_id` `product_id` INT(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Product ID',
...
ALTER TABLE `downloadable_sample`
    ...
    DROP INDEX IF EXISTS `DOWNLOADABLE_SAMPLE_PRODUCT_ID`,
    DROP COLUMN IF EXISTS `product_id`,
    CHANGE COLUMN `new_product_id` `product_id` INT(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Product ID',
...
ALTER TABLE `catalog_product_bundle_selection_price`
    DROP FOREIGN KEY IF EXISTS `CAT_PRD_BNDL_SELECTION_PRICE_PARENT_PRD_ID_CAT_PRD_ENTT_ROW_ID`,
    DROP FOREIGN KEY IF EXISTS `CAT_PRD_BNDL_SELECTION_PRICE_WS_ID_STORE_WS_WS_ID`,
    DROP FOREIGN KEY IF EXISTS `FK_AE9FDBF7988FB6BE3E04D91DA2CFB273`,
    DROP PRIMARY KEY,
...
ALTER TABLE `catalog_product_bundle_selection`
    DROP FOREIGN KEY IF EXISTS `CAT_PRD_BNDL_SELECTION_OPT_ID_SEQUENCE_PRD_BNDL_OPT_SEQUENCE_VAL`,
    DROP FOREIGN KEY IF EXISTS `CAT_PRD_BNDL_SELECTION_PARENT_PRD_ID_CAT_PRD_ENTT_ROW_ID`,
    DROP FOREIGN KEY IF EXISTS `CAT_PRD_BNDL_SELECTION_PRD_ID_SEQUENCE_PRD_SEQUENCE_VAL`,
    DROP FOREIGN KEY IF EXISTS `FK_606117FEB5F50D0182CEC9D260C05DD2`,
    DROP PRIMARY KEY,
    DROP COLUMN IF EXISTS `parent_product_id`,
    CHANGE COLUMN `new_parent_product_id` `parent_product_id` INT(10) UNSIGNED NOT NULL COMMENT 'Parent Product ID',
...
ALTER TABLE `catalog_product_entity_datetime`
    ...
    DROP INDEX IF EXISTS `CATALOG_PRODUCT_ENTITY_DATETIME_ENTITY_ID_ATTRIBUTE_ID_STORE_ID`,
...
ALTER TABLE `catalog_product_entity_decimal`
    ...
    DROP INDEX IF EXISTS `CATALOG_PRODUCT_ENTITY_DECIMAL_ENTITY_ID_ATTRIBUTE_ID_STORE_ID`,
...
ALTER TABLE `catalog_product_entity_int`
    ...
    DROP INDEX IF EXISTS `CATALOG_PRODUCT_ENTITY_INT_ENTITY_ID_ATTRIBUTE_ID_STORE_ID`,
...
ALTER TABLE `catalog_product_entity_text`
    ...
    DROP INDEX IF EXISTS `CATALOG_PRODUCT_ENTITY_TEXT_ENTITY_ID_ATTRIBUTE_ID_STORE_ID`,
...
ALTER TABLE `catalog_product_entity_varchar`
    ...
    DROP INDEX IF EXISTS `CATALOG_PRODUCT_ENTITY_VARCHAR_ENTITY_ID_ATTRIBUTE_ID_STORE_ID`,
...
ALTER TABLE `catalog_product_entity_gallery`
    ...
    DROP INDEX IF EXISTS `CATALOG_PRODUCT_ENTITY_GALLERY_ENTITY_ID_ATTRIBUTE_ID_STORE_ID`,
...
ALTER TABLE `catalog_product_entity_media_gallery_value`
    ...
    DROP INDEX IF EXISTS `CAT_PRD_ENTT_MDA_GLR_VAL_ENTT_ID_VAL_ID_STORE_ID`,
...
ALTER TABLE `catalog_product_entity_media_gallery_value_to_entity`
    ...
    DROP CONSTRAINT IF EXISTS `CAT_PRD_ENTT_MDA_GLR_VAL_TO_ENTT_VAL_ID_ENTT_ID`,
...
ALTER TABLE `catalog_product_entity_tier_price`
    ...
    DROP INDEX IF EXISTS `UNQ_E8AB433B9ACB00343ABB312AD2FAB087`,
...
ALTER TABLE `catalog_product_index_tier_price`
    DROP FOREIGN KEY IF EXISTS `CAT_PRD_IDX_TIER_PRICE_ENTT_ID_SEQUENCE_PRD_SEQUENCE_VAL`,
...
ALTER TABLE `catalog_product_website`
    DROP FOREIGN KEY IF EXISTS `CAT_PRD_WS_PRD_ID_SEQUENCE_PRD_SEQUENCE_VAL`,
...
ALTER TABLE `cataloginventory_stock_item`
    DROP FOREIGN KEY IF EXISTS `CATINV_STOCK_ITEM_PRD_ID_SEQUENCE_PRD_SEQUENCE_VAL`,
...
ALTER TABLE `product_alert_price`
    DROP FOREIGN KEY IF EXISTS `PRODUCT_ALERT_PRICE_PRODUCT_ID_SEQUENCE_PRODUCT_SEQUENCE_VALUE`,
...
ALTER TABLE `product_alert_stock`
    DROP FOREIGN KEY IF EXISTS `PRODUCT_ALERT_STOCK_PRODUCT_ID_SEQUENCE_PRODUCT_SEQUENCE_VALUE`,
...
ALTER TABLE `report_compared_product_index`
    DROP FOREIGN KEY IF EXISTS `REPORT_CMPD_PRD_IDX_PRD_ID_SEQUENCE_PRD_SEQUENCE_VAL`,
...
ALTER TABLE `report_viewed_product_aggregated_daily`
    DROP FOREIGN KEY IF EXISTS `REPORT_VIEWED_PRD_AGGRED_DAILY_PRD_ID_SEQUENCE_PRD_SEQUENCE_VAL`,
...
ALTER TABLE `report_viewed_product_aggregated_monthly`
    DROP FOREIGN KEY IF EXISTS `FK_0140003A30AFC1A9188D723C4634BA5D`,
...
ALTER TABLE `report_viewed_product_aggregated_yearly`
    DROP FOREIGN KEY IF EXISTS `REPORT_VIEWED_PRD_AGGRED_YEARLY_PRD_ID_SEQUENCE_PRD_SEQUENCE_VAL`,
...
ALTER TABLE `report_viewed_product_index`
    DROP FOREIGN KEY IF EXISTS `REPORT_VIEWED_PRD_IDX_PRD_ID_SEQUENCE_PRD_SEQUENCE_VAL`,
...
ALTER TABLE `weee_tax`
    DROP FOREIGN KEY IF EXISTS `WEEE_TAX_ENTITY_ID_SEQUENCE_PRODUCT_SEQUENCE_VALUE`,
...
ALTER TABLE `wishlist_item`
    DROP FOREIGN KEY IF EXISTS `WISHLIST_ITEM_PRODUCT_ID_SEQUENCE_PRODUCT_SEQUENCE_VALUE`,
